...
func (r *respository) GetUser(ctx context.Context, email, username string, userID int64) (*memberships.UserModel, error) {
...
func (r *respository) CreateUser(ctx context.Context, model memberships.UserModel) error {
